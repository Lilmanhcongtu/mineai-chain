...
3. The vulnerability-reporting contact is defined (security@mineai.dev). Still open: make sure that mailbox receives mail, and define the response and incident/reset process (`SECURITY_CHECKLIST.md`).
