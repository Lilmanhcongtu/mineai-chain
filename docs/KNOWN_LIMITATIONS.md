...
* **Vulnerability reporting:** the contact is security@mineai.dev (`SECURITY.md`), and a best-effort response process exists (`VULNERABILITY_RESPONSE.md`); the mailbox cannot receive mail yet.
